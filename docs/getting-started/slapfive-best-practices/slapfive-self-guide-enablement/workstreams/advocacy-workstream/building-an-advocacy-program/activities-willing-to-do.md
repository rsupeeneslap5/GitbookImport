...
**There are Parent Activity Types and there are Child Activity types.**

* Parent = the activity the Customer/Member/Advocate is willing to do what they said yes to on their sign up form.
* Child activity = the completed activity your Customer/Member/Advocate Completed&#x20;

**For example:**

* Parent activity type = Speaker
* Child Activity type = logged an activity for your advocate Speaker with child activity Speaker at CXCon 2026
