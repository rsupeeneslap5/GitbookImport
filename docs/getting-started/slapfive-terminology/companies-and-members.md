...
Organizations that Members are associated with. A Company can have multiple Members and can be tracked using attributes such as industry, company size, location, customer tenure, products used, and competitors replaced.
